...
def Disount_Cal(total_amount):
  ...
  if (total_amount < 2500):
    amount = total_amount - total_amount * 5/100 
  elif (total_amount > 2500 and total_amount < 5000):
    amount = total_amount - total_amount * 10/100
  elif (total_amount > 5000):
    amount = total_amount - total_amount * 15/100
  
  print(f"Discounted amount: {amount:.2f}")
